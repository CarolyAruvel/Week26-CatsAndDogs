...
namespace CatsDogsDB
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            connectionString = ConfigurationManager.ConnectionStrings["CatsDogsDB.Properties.Settings.PetsConnectionString"].ConnectionString;
        }
        ...
        private void PopulatePetNames()
        {
            ...
            using (SqlDataAdapter adapter = new SqlDataAdapter(command))
            {
                ...
                listPets.DisplayMember = "PetTypeName";
                listPets.ValueMember = "Id";
                listPets.DataSource = petNameTable;
            }
